...
const float dx01 =  + 0.00592114 *x*dy + -0.0022394 *x*y + 0.000102228 *lens_ipow(y, 3)*dx + -4.33422e-06 *lens_ipow(x, 3)*y+0.0f;
const float dx02 =  + 50.1459  + -20.779 *lens_ipow(dy, 2) + -60.986 *lens_ipow(dx, 2) + 0.636822 *x*dx + 0.013221 *lens_ipow(x, 2) + 2.55569e-05 *lens_ipow(y, 4)+0.0f;
const float dx03 =  + -41.558 *dx*dy + 0.505818 *x*dy + 0.00592114 *x*y+0.0f;
const float dx04 =  + 0.189872 *x+0.0f;
const float dx10 =  + 0.00582583 *y*dx + -0.0022233 *x*y + -4.52677e-06 *x*lens_ipow(y, 3) + 0.000101196 *lens_ipow(x, 3)*dy+0.0f;
const float dx11 =  + -0.512954  + 0.190038 *lambda + 0.329953 *lens_ipow(dy, 2) + 0.252932 *lens_ipow(dx, 2) + 0.02703 *y*dy + -0.00245958 *lens_ipow(y, 2) + 0.00582583 *x*dx + -0.00111165 *lens_ipow(x, 2) + -6.27129e-06 *lens_ipow(y, 4) + -6.79016e-06 *lens_ipow(x, 2)*lens_ipow(y, 2)+0.0f;
const float dx12 =  + -41.5749 *dx*dy + 0.505864 *y*dx + 0.00582583 *x*y+0.0f;
...
const float dx20 =  + -0.0134161  + -0.00247318 *lambda + -0.00243114 *lens_ipow(dy, 2) + -0.000100289 *y*dy + 8.72631e-06 *lens_ipow(y, 2) + 3.19944e-05 *lens_ipow(x, 2) + 2.22203e-08 *lens_ipow(y, 4) + 6.55096e-05 *x*y*dx*dy + 1.37938e-07 *lens_ipow(x, 2)*lens_ipow(y, 2) + -2.15776e-06 *lens_ipow(x, 3)*dx + 8.2867e-08 *lens_ipow(x, 4)+0.0f;
...
const float dx22 =  + -0.609054  + 0.167404 *lens_ipow(dy, 2) + 0.815817 *lens_ipow(dx, 2) + 3.27548e-05 *lens_ipow(x, 2)*y*dy + -5.3944e-07 *lens_ipow(x, 4)+0.0f;
...
const float dx30 =  + 0.00456728 *dx*dy + -9.96711e-05 *y*dx + 1.88616e-05 *x*y + 9.61326e-08 *x*lens_ipow(y, 3) + 9.48153e-08 *lens_ipow(x, 3)*y+0.0f;
const float dx31 =  + -0.0133897  + -0.00244101 *lambda + -0.00440674 *lens_ipow(dx, 2) + 2.94885e-05 *lens_ipow(y, 2) + -9.96711e-05 *x*dx + 9.43078e-06 *lens_ipow(x, 2) + -2.1269e-06 *lens_ipow(y, 3)*dy + 9.10982e-08 *lens_ipow(y, 4) + 1.44199e-07 *lens_ipow(x, 2)*lens_ipow(y, 2) + 2.37038e-08 *lens_ipow(x, 4)+0.0f;
const float dx32 =  + 0.737955 *dx*dy + -0.00881348 *y*dx + 0.00456728 *x*dy + -9.96711e-05 *x*y+0.0f;
