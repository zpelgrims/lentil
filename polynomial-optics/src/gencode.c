...
int main(int argc, char **argv)
{
  ...
  std::string init_h_path = lens_id_path + "/code/init_h_path.h";
  ...
  std::string case_lens_name = lens_database[id]["company"].get<std::string>();
  case_lens_name += "_";
  case_lens_name += lens_database[id]["product-name"].get<std::string>();
  case_lens_name += "_";
